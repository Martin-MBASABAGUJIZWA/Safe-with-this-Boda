        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MotoPlateNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Start_Latitude = table.Column<double>(type: "double", nullable: false),
                    Start_Longitude = table.Column<double>(type: "double", nullable: false),
                    End_Latitude = table.Column<double>(type: "double", nullable: false),
                    End_Longitude = table.Column<double>(type: "double", nullable: false),
